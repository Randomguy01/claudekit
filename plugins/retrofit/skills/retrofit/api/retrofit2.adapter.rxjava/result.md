...
The result of executing an HTTP request — either a [`Response`](../retrofit2/response.md) or an error. Emitted by service methods returning `Observable<Result<T>>` (see [`RxJavaCallAdapterFactory`](rxjava-call-adapter-factory.md)).
