...
Declares an index on an [`Entity`](entity.md). See: [SQLite Index Documentation](https://sqlite.org/lang_createindex.html)
...
The order of columns is important as it defines when SQLite can use a particular index. See [SQLite documentation](https://www.sqlite.org/optoverview.html) for details on index usage in the query optimizer.
