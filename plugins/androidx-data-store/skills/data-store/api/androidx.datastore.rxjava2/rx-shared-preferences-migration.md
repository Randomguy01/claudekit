...
Client-implemented `SharedPreferences`-to-DataStore migration interface, expressed with RxJava 2 types. Wrap an implementation with [`RxSharedPreferencesMigrationBuilder`](rx-shared-preferences-migration-builder.md) to produce a [`DataMigration`](../androidx.datastore.core/data-migration.md).
