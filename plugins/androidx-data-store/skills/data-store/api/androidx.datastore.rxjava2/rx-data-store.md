...
A [`DataStore`](../androidx.datastore.core/data-store.md) that exposes RxJava 2 operations. Build one with [`RxDataStoreBuilder`](rx-data-store-builder.md). Implements RxJava's `Disposable`.
